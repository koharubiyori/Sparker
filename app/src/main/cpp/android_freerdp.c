...
JNIEXPORT jlong JNICALL Java_koharubiyori_sparker_jni_JniFreeRDP_new(
...
JNIEXPORT void JNICALL Java_koharubiyori_sparker_jni_JniFreeRDP_free(
...
Java_koharubiyori_sparker_jni_JniFreeRDP_getLastErrorString(JNIEnv* env,
                                                            jclass cls,
                                                            jlong instance)
{
	freerdp* inst = (freerdp*)instance;
...
Java_koharubiyori_sparker_jni_JniFreeRDP_parseArguments(JNIEnv* env, jclass cls,
                                                        jlong instance,
...
JNIEXPORT jboolean JNICALL Java_koharubiyori_sparker_jni_JniFreeRDP_connect(
    JNIEnv* env, jclass cls, jlong instance)
{
	freerdp* inst = (freerdp*)instance;
	androidContext* ctx;
...
JNIEXPORT jboolean JNICALL Java_koharubiyori_sparker_jni_JniFreeRDP_disconnect(
    JNIEnv* env, jclass cls, jlong instance)
{
	freerdp* inst = (freerdp*)instance;
	androidContext* ctx;
...
JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_updateGraphics(JNIEnv* env, jclass cls,
                                                        jlong instance,
...
JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_sendKeyEvent(JNIEnv* env, jclass cls,
                                                      jlong instance,
                                                      jint keycode,
                                                      jboolean down)
{
...
JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_sendUnicodekeyEvent(
...
JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_sendCursorEvent(
...
JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_sendClipboardData(JNIEnv* env,
                                                           jclass cls,
                                                           jlong instance,
                                                           jstring jdata)
{
...
JNIEXPORT jstring JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_getJniVersion(JNIEnv* env, jclass cls)
{
	return (*env)->NewStringUTF(env, FREERDP_JNI_VERSION);
}

JNIEXPORT jboolean JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_hasH264(JNIEnv* env, jclass cls)
{
...
JNIEXPORT jstring JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_getVersion(JNIEnv* env, jclass cls)
{
	return (*env)->NewStringUTF(env, freerdp_get_version_string());
}

JNIEXPORT jstring JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_getBuildRevision(JNIEnv* env,
                                                          jclass cls)
{
...
JNIEXPORT jstring JNICALL
Java_koharubiyori_sparker_jni_JniFreeRDP_getBuildConfig(JNIEnv* env,
                                                        jclass cls)
{
